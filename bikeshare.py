...
def get_filters():
    ...
    while True:
      month=str(input('Do you want choose a specific month? If yes, type a month. If no, type all\n')).title()
    ...
    while True:
      day=str(input('Do you want choose a specific day? If yes, type a day. If no, type all\n')).title()
      if day not in days:
...
def load_data(city, month, day):
    ...
    # convert Start Time inti column to datetime
...
def time_stats(df):
    ...
    print('The most common satrt hour is: {}'.format(df['hour'].mode()[0]))
...
def station_stats(df):
    ...
    print('The most frequent combination is: {}'.format(most_common_combination.mode()[0]))
...
def trip_duration_stats(df):
    ...
    print('The total travel time is: ',mean_h,' hours, ',mean_m,' minutes, and ',mean_s,' seconds. ')
